        ...
        <section class="container" style="max-width:1020px;">
          <div class="grid-2 glass-card" style="overflow:hidden; align-items:stretch;">
            ...
            <div class="card" style="padding:2rem;">
              ...
              <form id="experiment6-form" class="assignment-form" action="post_registration.php" method="post" novalidate style="margin-top:1rem;">
                <div class="assignment-grid">
                  <div class="assignment-field">
                    <label class="mini-label" for="full_name">Full Name</label>
                    <input id="full_name" name="full_name" type="text" placeholder="John Doe" />
                    <div class="assignment-error" data-error-for="full_name"></div>
                  </div>

                  <div class="assignment-field">
                    <label class="mini-label" for="email">Email Address</label>
                    <input id="email" name="email" type="email" placeholder="name@example.com" />
                    <div class="assignment-error" data-error-for="email"></div>
                  </div>
                </div>
                ...
                <div class="assignment-grid">
                  <div class="assignment-field">
                    <label class="mini-label" for="password">Password</label>
                    <input id="password" name="password" type="password" placeholder="Create a password" />
                    <div class="assignment-error" data-error-for="password"></div>
                  </div>

                  <div class="assignment-field">
                    <label class="mini-label" for="training_days">Training Days Per Week</label>
                    <input id="training_days" name="training_days" type="number" min="1" max="7" placeholder="4" />
                    <div class="assignment-error" data-error-for="training_days"></div>
                  </div>
                </div>

                <div class="assignment-grid">
                  <div class="assignment-field">
                    <label class="mini-label" for="fitness_goal">Fitness Goal</label>
                    ...
                    <div class="assignment-error" data-error-for="fitness_goal"></div>
                  </div>

                  <div class="assignment-field">
                    <label class="mini-label" for="experience_level">Experience Level</label>
                    ...
                    <div class="assignment-error" data-error-for="experience_level"></div>
                  </div>
                </div>

                <div class="assignment-field">
                  <label class="mini-label" for="notes">Workout Notes</label>
                  <textarea id="notes" name="notes" placeholder="Optional: mention your training focus or routine."></textarea>
                  <div class="assignment-hint">Optional notes for your training focus.</div>
                  <div class="assignment-error" data-error-for="notes"></div>
                </div>

                <div class="assignment-field">
                  <div id="form-status" class="assignment-error" aria-live="polite"></div>
                </div>
